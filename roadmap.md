...
## Phase 1: DBMS Vendor Support [DEFFERED]
### Description
...
## Phase 2: Infrastructure & Advanced Blocks [DEFFERED]
### Description
...
## Phase 3: Update ./conf/*.sql scripts
### Description
...
## Phase 4: Action tracker Labels and description
### Description
...
## Phase 5: Enhance test suite - fill forms with random values
### Description
...
## Phase 6: Change UI media queries for mobile
### Description
...
## Phase 7: Federate naming convention for event store
### Description
