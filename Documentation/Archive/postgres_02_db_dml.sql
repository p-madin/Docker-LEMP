...
(9, 'pagAuthorFK', 'Author ID', 'number', '{"required":true}', 40),
...
INSERT INTO tblForm (tfName, tfAction, tfReadOnly) VALUES ('createChildService', 'createChildService', false);
...
ALTER TABLE tblPages ALTER COLUMN pagPK SET GENERATED BY DEFAULT;
ALTER TABLE tblElements ALTER COLUMN elePK SET GENERATED BY DEFAULT;
...
ALTER TABLE tblPages ALTER COLUMN pagpk SET GENERATED ALWAYS;
ALTER TABLE tblElements ALTER COLUMN elePK SET GENERATED ALWAYS;
...
VALUES ('Create Child Service Action', 'a', NULL, '/createChildService', 'CreateChildServiceAction', false, 0);

-- Route in tblNavBar for childServiceAction
INSERT INTO tblNavBar (nbText, nbDiscriminator, nbPageFK, nbPath, nbControllerClass, nbProtected, nbOrder) 
VALUES ('Child Service Action', 'a', NULL, '/childServiceAction', 'ChildServiceAction', false, 0);
