...
if ($id > 0) {
    ...
    if (!$u) {
        ...
        $dom->fabricateChild($wrapper, "a", ["href"=>"navbar_management.php", "class"=>"button"], "Back to List");
...
$hlink->appendHyperlinkForm($dom, $wrapper_bottom, "Back to Navbar List", "/navbar_management.php");
